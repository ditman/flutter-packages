  ...
  group('$AdvancedMarker', () {
    ...
    test('constructor alpha is >= 0.0 and <= 1.0', () {
      void initWithAlpha(double alpha) {
        AdvancedMarker(markerId: const MarkerId('ABC123'), alpha: alpha);
      }
    ...
    test('copyWith', () {
      ...
      final AdvancedMarker copy = marker.copyWith(
        ...
        collisionBehaviorParam: testCollisionBehavior,
        onTapParam: () {
          log.add('onTapParam');
        },
      ...
      expect(copy.collisionBehavior, equals(testCollisionBehavior));
